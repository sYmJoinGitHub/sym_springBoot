...
import static com.sym.hystrix.constants.HystrixCommandPropertiesConstants.CircuitBreaker.CIRCUIT_BREAKER_ENABLED;
import static com.sym.hystrix.constants.HystrixCommandPropertiesConstants.CircuitBreaker.CIRCUIT_BREAKER_ERROR_THRESHOLD_PERCENTAGE;
import static com.sym.hystrix.constants.HystrixCommandPropertiesConstants.CircuitBreaker.CIRCUIT_BREAKER_REQUEST_VOLUME_THRESHOLD;
import static com.sym.hystrix.constants.HystrixCommandPropertiesConstants.CircuitBreaker.CIRCUIT_BREAKER_SLEEP_WINDOW_IN_MILLISECONDS;
import static com.sym.hystrix.constants.HystrixCommandPropertiesConstants.ThreadIsolation.EXECUTION_ISOLATION_SEMAPHORE_MAX_CONCURRENT_REQUESTS;
import static com.sym.hystrix.constants.HystrixCommandPropertiesConstants.ThreadIsolation.EXECUTION_ISOLATION_STRATEGY;
import static com.sym.hystrix.constants.HystrixCommandPropertiesConstants.ThreadIsolation.EXECUTION_ISOLATION_THREAD_TIMEOUT_IN_MILLISECONDS;
import static com.sym.hystrix.constants.HystrixCommandPropertiesConstants.ThreadIsolation.EXECUTION_TIMEOUT_ENABLED;
import static com.sym.hystrix.constants.HystrixCommandPropertiesConstants.ThreadPool.CORE_SIZE;
import static com.sym.hystrix.constants.HystrixCommandPropertiesConstants.ThreadPool.MAX_QUEUE_SIZE;
