 ...
 */
public class SymApplicationListener1 implements ApplicationListener<ApplicationPreparedEvent> {

    @Override
    public void onApplicationEvent(ApplicationPreparedEvent event) {
        System.err.println("SymApplicationListener1.onApplicationEvent()");
    }
}
