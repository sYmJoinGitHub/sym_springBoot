...
public class RabbitMQTest {
    ...
    public void testOne(){
        ...
        ProductBean productBean = new ProductBean(01,"笔记本",16.25,"挺不错的",false);
    ...
    public void testTwo(){
        ...
        ProductBean productBean = new ProductBean(02,"可口可乐",2.36,"真难喝",false);
    ...
    public void testThree(){
        ProductBean productBean = new ProductBean(03,"1060ti显卡",2455.12,"我喜欢",true);
